    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http, ClientRegistrationRepository clientRegistrationRepository) throws Exception {
        http
            ...
            .authorizeHttpRequests(auth -> auth
                ...
                .requestMatchers(HttpMethod.GET, "/api/v1/service-posts/all").permitAll()
                .requestMatchers(HttpMethod.GET, "/api/v1/service-posts/{id}").permitAll()
                .requestMatchers(HttpMethod.GET, "/api/v1/service-posts/user/{id}").permitAll()
                .requestMatchers(HttpMethod.GET, "/api/v1/job-applications/user-applications/{id}").permitAll()
